...
internal sealed class WarehouseModuleInitializer : IModuleInitializer
{
    ...
    private readonly ILogger<WarehouseModuleInitializer> _logger;

    public WarehouseModuleInitializer(WarehouseDbContext db, ILogger<WarehouseModuleInitializer> logger)
    {
        _db = db;
        _logger = logger;
    }
...
/// <summary>
/// Seed data for the catalogue. Product ids are fixed GUIDs (prefix <c>10000000-…</c>) so the demo
/// data is stable and coherent across runs.
/// </summary>
internal static class WarehouseSeed
{
    ...
    [
        ...
        new(P(4),  "MON-27-4K",  "27\" 4K Monitor",           "27-inch 4K UHD IPS monitor, USB-C 90W.",                  "Displays",    329.00m, 60),
        new(P(5),  "MON-34-UW",  "34\" Ultrawide Monitor",    "34-inch curved ultrawide, 144Hz.",                        "Displays",    549.00m, 28),
        ...
        new(P(13), "RTR-WIFI6",  "Wi-Fi 6 Router",            "Dual-band AX3000 Wi-Fi 6 router.",                        "Networking",  99.00m, 75),
