...
/// <summary>
/// Seed data for Shipping (shipment ids use the prefix <c>40000000-…</c>). These deliberately
/// mirror the historical orders seeded by the Sales module (order ids <c>30000000-…</c>) so the
/// demo data is coherent. In normal operation Shipping learns about an order ONLY through the
/// <c>OrderPlaced</c> event — this seed is a one-off for a populated first-run experience.
/// </summary>
