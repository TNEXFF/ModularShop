...
public sealed class Order : Entity
{
    ...
    public Order(string orderNumber, Guid customerId, string customerName, string placedBy,
        DateTime placedOnUtc, string currencyCode = "USD", Guid id = default)
        : base(id)
    {
    ...
    // The line's own id is generated by EF; its OrderId FK is set by EF from this Lines navigation on save.
