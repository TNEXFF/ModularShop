...
/// <summary>
/// Seed data for Sales. Order ids use the prefix <c>30000000-…</c> and reference the kernel customer ids
/// (<c>20000000-…</c>) and Warehouse product ids (<c>10000000-…</c>) with matching names/prices, so the
/// demo data is coherent across modules.
/// </summary>
