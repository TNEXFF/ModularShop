...
/// <summary>
/// Seed data for Sales. Customer ids use the prefix <c>20000000-…</c> and order ids
/// <c>30000000-…</c>. Historical order lines reference Warehouse product ids (<c>10000000-…</c>)
/// with the same names/prices as the Warehouse seed, so the demo data is coherent.
/// </summary>
